...
import {
  ...
  LMS_DASHBOARD_STATS,
} from '@/features/lms/mocks/lms-dashboard.mock'
        ...
        <div className="grid grid-cols-[1fr_320px] gap-5">
          <div>
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/lms/progress" className="text-primary cursor-pointer text-xs font-medium transition-opacity duration-150 hover:opacity-75">
                View all →
              </Link>
            </div>
