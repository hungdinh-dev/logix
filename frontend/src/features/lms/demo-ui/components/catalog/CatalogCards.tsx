    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2.5 p-4">
        ...
        {course.enrolledByMe ? (
          ...
          <Link
            href={courseLearnPath}
            className="flex w-full cursor-pointer items-center justify-center rounded-md py-2 text-[12px] font-semibold text-white transition-colors duration-150"
